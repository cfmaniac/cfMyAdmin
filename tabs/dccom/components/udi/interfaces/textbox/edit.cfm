...
<tr><td>Columns:</td><td><input type="text" name="_columns" size="5" value="" onkeypress="ensureInt(this)">
<div class="info">
OPTIONAL. Default is 40.
</div>
</td></tr>
<tr><td>Rows:</td><td><input type="text" name="_rows" size="5" value="" onkeypress="ensureInt(this)">
<div class="info">
OPTIONAL. Default is 4.
</div>
</td></tr>
<tr><td>Maximum Length:</td><td><input type="text" name="_maxlength" size="5" value="" onkeypress="ensureInt(this)"></td></tr>
<tr><td>Text Wrap:</td><td>
<select name="_wrap"><option value="">Default (soft wrap)</option>
<option value="hard">Hard Wrap</option>
...
function init()
{
	with(document.editForm)
	{
		...
		_columns.value = getVar("columns");
		_rows.value = getVar("rows");
		_maxlength.value = getVar("maxlength");
		_wrap.value = getVar("wrap");
...
function updateChanges()
{
	with(document.editForm)
	{
		...
		if(_columns.value!="") setVar("columns",_columns.value);
		if(_rows.value!="") setVar("rows",_rows.value);
		if(_maxlength.value!="") setVar("maxlength",_maxlength.value);
		setVar("wrap",_wrap.value);
