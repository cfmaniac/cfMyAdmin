...
<tr><td width="95">Default Value:</td><td><input type="text" name="_default" size="40" value="" onkeypress="ensureFloat(this)"></td></tr>
...
<div class="info">
Check this option to force the user to enter some text.
</div>
</td></tr>
